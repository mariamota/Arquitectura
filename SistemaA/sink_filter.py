        ...
        while True:
            try:
                ...
                if idMeasurement == 0:
                    ...
                    print "ID = {0}  Tiempo {1}".format(idMeasurement, timeStamp.strftime(timeStampFormat))
                    a[0]="{0}\t".format( timeStamp.strftime(timeStampFormat)) 
                ...
                if idMeasurement == 2:
                    ...
                    print "ID = {0} Altitud {1}".format( idMeasurement, doubleValue) 
                    a[2]="%.5f \t" % doubleValue  
